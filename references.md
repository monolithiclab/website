...
description: "MeilleursAgents, construit de zéro jusqu’au leader français de l’estimation immobilière en ligne, et Prose, cofondée en 2017 : deux entreprises dont Nicolas Mussat a construit la technique et l’équipe."
alternate: "/en-us/references"
hero:
  compact: true
  label: "Références"
  headline: "Deux entreprises, construites depuis le premier jour"
...
### Tout construire, du premier serveur à une équipe de 30

**Contexte.** En avril 2008, MeilleursAgents n’a ni produit, ni code, ni équipe technique. L’ambition : estimer la valeur de chaque logement en France, immeuble par immeuble, et simplifier la transaction immobilière. Nicolas Mussat en est le premier salarié, six mois avant l’ouverture du site au public.
...
### Cofonder l’entreprise, et construire la plateforme qui la fait tourner

**Contexte.** En 2017, Arnaud Plas, Paul Michaux, Catherine Taurin et Nicolas Mussat fondent Prose : des soins capillaires personnalisés, formulés pour chaque client après une consultation en ligne, fabriqués à la commande et livrés par abonnement. Une entreprise internationale dès le premier jour : siège et usines aux États-Unis, son premier marché, centre de recherche à Paris. Aucune plateforme e-commerce de l’époque ne sait gérer une consultation d’une trentaine d’étapes, un produit unique par client et une fabrication à la commande.

**Rôle.** Cofondateur et CTO de 2017 à 2025, depuis Paris. Nicolas Mussat choisit toute la stack (Python, React, PostgreSQL, Google Cloud, Kubernetes) et construit de zéro la plateforme qui fait tourner l’entreprise, de la consultation à l’usine. Il construit et dirige une équipe technique de 35 personnes : développeurs front-end et back-end, product owners, DevOps et data engineers.
...
- partir de zéro : le produit, la stack, l’hébergement, l’équipe
- faire grandir la technique et l’équipe au rythme de l’entreprise
- construire ce qui fait la différence, acheter le reste
- changer de modèle ou d’échelle sans casser ce qui rapporte
- laisser des systèmes que l’équipe fait vivre sans aide extérieure

Ce sont les réflexes qu’un [CTO à temps partagé](/cto-temps-partage) ou un [CTO de transition](/cto-de-transition) apporte à votre entreprise.
